...
def build_graph():
    ...
    with several predefined tools (e.g., databases, search functions, clinical notes lookup, etc.).
    ...
    Components:
        ...
        - `tools`: A list of tools including SQL queries, search functionalities, clinical notes lookup, etc.
